...
import type { InvoiceLine } from "./InvoicePreviewPage";
...
const lineAmount = (l: DraftLine) => l.qty * (Number(l.unitPrice) || 0);
      ...
      <BottomSheet
        ...
        footer={
          <ButtonDock
            ...
            onPrimary={() => setReasonSheetOpen(false)}
            homeIndicator
          />
        }
      >
      ...
      <BottomSheet
        ...
        footer={
          <ButtonDock
            type="single"
            primaryLabel="Save"
            primaryDisabled={!clientDirty || !clientValid}
            onPrimary={saveClient}
            homeIndicator
          />
        }
      >
