 ...
 * sheet — its own Close/Cancel exits the whole Create flow (never falls back to this chooser).
 * ScanDocument handles its own capture → review (Retake/Use Image) → add-another/finish loop
