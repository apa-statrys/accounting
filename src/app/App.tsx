...
export default function App() {
  ...
  // in-flow "Scan again" action (DuplicateDecision, AddInvoiceDetails) reaches it via
  ...
  // Standalone scanner overlay for in-flow "Scan again" actions (DuplicateDecision,
      ...
      sections: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: "Upload — Error (Too Large)", active: screen === "list" && uploadError?.kind === "tooLarge", onSelect: () => { setUploadError(null); setScreen("list"); setUploadError({ kind: "tooLarge", title: "Unsupported file format", body: <>This file can’t be uploaded. Please upload your invoice as a PDF, JPG, JPEG, or PNG file up to <strong>10 MB</strong>.</> }); } },
  ...
  return (
    <div className="mobile-mode min-h-screen bg-[#EDEDED] flex flex-col items-center justify-center gap-4 p-4">
      ...
      {screen === "send" && (
        ...
        {/* Standalone scanner for in-flow "Scan again" (DuplicateDecision, AddInvoiceDetails)
