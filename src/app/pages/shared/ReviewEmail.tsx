...
function Label({ children }: { children: React.ReactNode }) {
  return (
    <p className="text-[14px] font-bold leading-[1.2] text-[var(--text-primary)]" style={FONT}>
      {children}
    </p>
  );
}
  ...
  return (
    <div className="absolute inset-0 flex flex-col bg-white rounded-[48px] overflow-hidden">
      ...
      >
        ...
        <div className="px-4 pt-5 pb-44 flex flex-col gap-5">
          ...
          <div className="flex flex-col gap-2">
            ...
            <label className="flex items-center gap-2 cursor-pointer pt-0.5">
              ...
              <span className="text-[14px] leading-[1.2] text-[var(--text-primary)]" style={FONT}>
                Send me a copy
              </span>
            </label>
          </div>
          ...
          <div className="flex flex-col gap-2">
            ...
            <textarea
              ...
              rows={7}
              className="w-full resize-none rounded-xl border border-[rgba(160,160,160,0.45)] bg-white px-3.5 py-3 text-[14px] leading-[1.45] text-[var(--text-primary)] outline-none focus:border-[#1b1b1b]"
              style={FONT}
            />
          </div>
          ...
          <label className="flex items-center gap-2 cursor-pointer">
            ...
            <span className="text-[14px] leading-[1.3] text-[var(--text-primary)]" style={FONT}>
